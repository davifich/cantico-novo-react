...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, ScrollView, StatusBar, ActivityIndicator, AppState } from 'react-native';
...
const SongCard = memo(({ song, colors, onPress }: { song: Music; colors: typeof Colors.light; onPress: () => void }) => (
  <TouchableOpacity
...
export default function HomeScreen() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      ...
      setPopoverVisible(true); // Automatically open popover
        ...
        >
          <View style={styles.headerContent}>
            <View style={styles.headerTop}>
              ...
              <TouchableOpacity
                style={[styles.notificationButton, { backgroundColor: colors.secondary }]}
